    ...
    <div className="w-full sm:w-[30vw] -mt-[180px] sm:ml-[-500px] md:w-[55vw] lg:w-[30vw] lg:ml-[0px] sm:mt-4 p-4 bg-[#f5f4f5] rounded-lg  ">
      <div className="flex justify-between">
        ...
        <RxCross2
          ...
          onClick={() => dispatch(setTab(null))}
        />
      </div>

      <form
        className="ps-2 flex flex-col gap-y-4 w-[90%]"
      ...
      >
        <input
          ...
          } border px-2 py-1 rounded   focus:outline-none`}
        ...
        <textarea
          ...
          } border px-3 py-2  rounded resize-none`}
          name="Description"
        ...
        <button
          ...
          className="mt-10 bg-slate-800 text-white px-1 py-2 hover:bg-slate-600 rounded"
        >
          Create Task
        </button>
      </form>
